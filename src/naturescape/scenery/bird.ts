/**
 * Occasional bird flocks — a small V of silhouettes crossing the daytime sky, wings flapping (a
 * stateless function of the clock). A director holds a countdown whose interval shortens with the
 * live `birds` knob; when it fires it launches one flock that crosses and then idles.
 *
 * @module
 */
...
export class BirdDirector implements Entity<NatureEnv> {
	readonly depth = 0.5;
	...
	draw(ctx: DrawContext): void {
		...
		// A soft dark silhouette against the bright sky.
