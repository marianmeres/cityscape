...
| 16   | Re-tune the curated default snapshot                      | [00](./00-overview-and-roadmap.md) | ⏸️ owner review                   |
...
- **2026-06-20** — Task 16 is **⏸️ owner-gated**: re-tuning the curated default snapshot needs eyes on screen. Did the buildable parts (AGENTS.md structure refreshed, docs ticked). No defaults changed blind. Open lever: `biomeScale` default 5 (slow ~3 min cycle) — consider 2–3 for legibility.
